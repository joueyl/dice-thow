import { Group, PerspectiveCamera, PointLight, Scene, WebGLRenderer } from 'three';
import { Body, ContactMaterial, World } from 'cannon-es';
...
export declare class Dice {
    ...
    localView(): void;
    getNumber(): any;
    isBodyStoped(body: Body, linearVelocityThreshold?: number, angularVelocityThreshold?: number): boolean;
}
export {};
